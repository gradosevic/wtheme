...
<div id="wrapper">
            ...
            <div class="col-md-9">
                <main id="content">
                    <div class="post-intro">
                        ...
                        <img class="circle md-hide" src="/wp-content/themes/muhamed/img/post-thumbnail-1.jpg" />
                    ...
                    <div class="post-intro">
                        ...
                        <img class="circle md-hide" src="/wp-content/themes/muhamed/img/post-thumbnail-2.jpg" />
    ...
    <footer id="footer" class="container-fluid menu-hidden">
        <div id="copyright">
        ...
        <a class="menu md-show">MENU</a>
        <a class="menu menu-close md-show">X</a>
    </footer>
